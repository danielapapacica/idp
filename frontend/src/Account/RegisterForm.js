    ...
    <div className="RegisterForm">
      ...
      <form data-toggle="validator" role="form">
        ...
        <div class="w-75 form-group">
          ...
          <input type="text" pattern="^(?=[a-zA-Z0-9._]{6,20}$)(?!.*[_.]{2})[^_.].*[^_.]$" class="form-control" id="regUser" placeholder="Username" required/>
        </div>
        ...
        <div class="mr-5"> Termeni si conditii bla bla bla. Prin bifarea acestui checkbox sunt de acord ca voi sa primiti datele mele etc.</div>

        <br/>
        <div class="form-check">
          <input type="checkbox" class="form-check-input" id="regCheck" required/>
          <label class="form-check-label" for="regCheck">Sunt de acord cu ce scrie mai sus...</label>
        </div>
